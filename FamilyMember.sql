...
VALUES
  ...
  ("Althea","Wooten","wooten-althea@gmail.com","543","1986/12/14","0","NOQ48NBZ6EJ7VX3","9173437726"),
  ...
  ("Lillith","Clements","clementslillith@gmail.com","580","1986/01/24","0","XDO87SOP2EW3HI3","7451242583"),
  ("Kenneth","Stark","s.kenneth8623@gmail.com","765","1999/05/16","0","SAL57BPK7FP8AC7","7054214681"),
  ("Declan","Stout","s-declan@hotmail.com","834","1993/12/18","1","USE56ILE3LL7BD3","7402043345"),
  ("Michael","Bernard","bernard.michael4894@gmail.com","723","1980/06/28","0","XWI86UXG1BE4FQ3","2251444150"),
  ("Deirdre","Mcgowan","deirdre_mcgowan4790@yahoo.com","916","1995/05/30","1","NWK34XJN6OL6UQ2","7742282382"),
  ("Selma","Miller","s.miller1011@hotmail.com","837","1996/02/19","1","CXO41YRA3GJ5LY7","2918238974");
INSERT INTO `FamilyMember` (`fName`,`lName`,`email`,`familyCode`,`DOB`,`approval`,`password`,`phone`)
VALUES
  ...
  ("Amal","Calderon","c_amal5321@hotmail.com","950","1992/10/03","1","KIO27ONN9PF6OC5","8356293928"),
  ("Callum","Owens","owens_callum8490@hotmail.com","565","1993/07/07","1","CGU98FSC6IS2IS0","6701399143");
INSERT INTO `FamilyMember` (`fName`,`lName`,`email`,`familyCode`,`DOB`,`approval`,`password`,`phone`)
VALUES
  ("Armand","Wilcox","warmand@hotmail.com","756","1990/01/21","0","CLW66XNM5ZQ4VE3","8936982765"),
  ("Fitzgerald","Hudson","hudson-fitzgerald6457@gmail.com","316","1990/06/09","1","EXU28KIF4KO3IO5","5392250078"),
  ("Freya","Hodges","h_freya4131@hotmail.com","902","1985/10/22","0","UIE23RYW4YE0NL8","0216266426"),
  ("Logan","Abbott","logan.abbott4999@gmail.com","256","1992/08/21","0","LRM28RQQ5BN8QH5","8250926255"),
  ("Cooper","Alvarado","a-cooper9445@hotmail.com","729","1988/12/20","0","WTG09GGQ9EL6LO7","8179515155"),
  ...
  ("Paul","Weaver","paulweaver@yahoo.com","255","1984/12/06","1","WWE53QES8CS8RY7","6258740726"),
  ("Veda","Fry","veda_fry238@yahoo.com","779","1980/06/10","1","OJS78PYO5HH3RR5","8225753379");
INSERT INTO `FamilyMember` (`fName`,`lName`,`email`,`familyCode`,`DOB`,`approval`,`password`,`phone`)
VALUES
  ("Isaac","Leach","l.isaac6681@gmail.com","779","1995/10/09","0","KKT65MYE2JT7OE2","5698046507"),
  ...
  ("Ariana","Vinson","avinson9963@gmail.com","383","1984/07/13","0","OUS57ODS7KY8UJ5","5734167566"),
  ...
  ("Whoopi","O'donnell","w-odonnell@yahoo.com","952","1998/02/20","1","PRK09HGB8NA6GS3","4285788329"),
